...
namespace UnforgivenMod.Unforgiven.Content
{
    public static class UnforgivenAssets
    {
        ...
        private static void CreateProjectiles()
        {
            ...
            ProjectileController nadoProjectileController = nadoPrefab.GetComponent<ProjectileController>();
            nadoProjectileController.allowPrediction = true;
        ...
        {
            using (Stream manifestResourceStream2 = Assembly.GetExecutingAssembly().GetManifestResourceStream("UnforgivenMod.unforgiven_bank.bnk"))
            {
