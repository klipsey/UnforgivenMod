...
namespace UnforgivenMod.Unforgiven.Content
{
    public static class UnforgivenUnlockables
    {
        ...
        {
            /*
            masterySkinUnlockableDef = Modules.Content.CreateAndAddUnlockableDef(UnforgivenMasteryAchievement.unlockableIdentifier,
                Modules.Tokens.GetAchievementNameToken(UnforgivenMasteryAchievement.unlockableIdentifier),
                UnforgivenSurvivor.instance.assetBundle.LoadAsset<Sprite>("texMonsoonSkin"));
            */
            /*
            if (true == false)
            {
